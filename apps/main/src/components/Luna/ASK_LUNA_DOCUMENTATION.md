...
**Ask Luna** is Surim's AI-powered assistant that helps users discover the perfect next steps for their digital transformation projects. Luna provides a conversational, voice-first experience accessible directly from the navigation bar.
...
1. **Maintain Surim branding** (black/white/zinc)
...
**Development Team**: Surim Engineering
**Design**: Surim Design Team  
**Brand Assets**: Surim Marketing  
...
© 2025 Surim. All rights reserved.
...
**Maintained by**: Surim Engineering Team
